...
import {
    addMemberToDepartmentByManager, createMultipleDateDesignsByManager, deleteMultipleDateDesignsByManager,
...
router.delete('/manage-date-design/delete', verifyTokenManager, deleteMultipleDateDesignsByManager);
